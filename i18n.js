...
export const i18n = {
  en: {
    ...
    invoiceHint: "Create a branded invoice for a customer order. Fill in the details, then download a PDF to email or print. Tax is pre-set for Volusia County and can be adjusted per job.",
    invoiceBillTo: "Bill To",
    invCustName: "Customer name",
    invCustEmail: "Customer email",
    invCustPhone: "Customer phone",
    invDate: "Invoice date",
    invoiceItems: "Order Items",
    invAddItem: "Add Item",
    invItemDesc: "Item description",
    invTaxRate: "Tax rate (%)",
    invNotes: "Notes (optional)",
    invNotesPh: "Thank you for your order!",
    invSubtotal: "Subtotal",
    invTax: "Tax",
    invTotalDue: "Total Due",
    invDownloadPdf: "Download PDF Invoice",
    invPayNote: "The invoice shows your Zelle and Cash App details so customers can pay you directly. Update those anytime in the Checkout panel.",
    invSaved: "Invoice PDF downloaded",
    invNoPdfLib: "PDF library not loaded - refresh and try again",
    // Publish
    ...
    ordersNav: "Recent Orders",
    ordersTitle: "Recent Orders",
    ordersRefresh: "Refresh",
    ordersHint: "Every order placed on your site is saved here automatically — newest first. This is your record; it does not require email or SMS setup. Always confirm the customer's Zelle or Cash App payment arrived before cooking.",
    ordersLoading: "Loading orders…",
    ordersEmpty: "No orders yet. New orders will appear here automatically.",
    ordersError: "Could not load orders. Tap Refresh to try again.",
    ordersPickup: "Pickup",
    ordersNoPay: "Not specified",
    ordersDelete: "Delete order",
    ordersDeleteConfirm: "Delete this order permanently? This cannot be undone.",
    ordersDeleteError: "Could not delete the order. Please try again.",
  ...
  es: {
    ...
    invoiceTitle: "Generador de Facturas",
    invoiceHint: "Crea una factura con tu marca para el pedido de un cliente. Llena los datos y descarga un PDF para enviar por correo o imprimir. El impuesto está preconfigurado para el Condado de Volusia y se puede ajustar por trabajo.",
    invoiceBillTo: "Facturar a",
    invCustName: "Nombre del cliente",
    invCustEmail: "Correo del cliente",
    invCustPhone: "Teléfono del cliente",
    invDate: "Fecha de la factura",
    invoiceItems: "Artículos del Pedido",
    invAddItem: "Agregar Artículo",
    invItemDesc: "Descripción del artículo",
    invTaxRate: "Tasa de impuesto (%)",
    invNotes: "Notas (opcional)",
    invNotesPh: "¡Gracias por tu pedido!",
    invSubtotal: "Subtotal",
    invTax: "Impuesto",
    invTotalDue: "Total a Pagar",
    invDownloadPdf: "Descargar Factura PDF",
    invPayNote: "La factura muestra tus datos de Zelle y Cash App para que los clientes te paguen directamente. Actualízalos cuando quieras en el panel de Pagos.",
    invSaved: "Factura PDF descargada",
    invNoPdfLib: "Librería PDF no cargada - actualiza e intenta de nuevo",
    ...
    ordersNav: "Órdenes recientes",
    ordersTitle: "Órdenes recientes",
    ordersRefresh: "Actualizar",
    ordersHint: "Cada orden hecha en tu sitio se guarda aquí automáticamente — la más reciente primero. Este es tu registro; no requiere configurar correo ni SMS. Confirma siempre que el pago del cliente por Zelle o Cash App haya llegado antes de cocinar.",
    ordersLoading: "Cargando órdenes…",
    ordersEmpty: "Aún no hay órdenes. Las nuevas aparecerán aquí automáticamente.",
    ordersError: "No se pudieron cargar las órdenes. Toca Actualizar para intentar de nuevo.",
    ordersPickup: "Recoger",
    ordersNoPay: "No especificado",
    ordersDelete: "Eliminar orden",
    ordersDeleteConfirm: "¿Eliminar esta orden permanentemente? Esto no se puede deshacer.",
    ordersDeleteError: "No se pudo eliminar la orden. Inténtalo de nuevo.",
    addToOrder: "+ Agregar",
    added: "✓ Agregado",
